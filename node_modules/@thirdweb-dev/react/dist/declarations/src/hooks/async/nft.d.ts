import { AirdropNFTParams, BurnNFTParams, MintNFTParams, MintNFTReturnType, MintNFTSupplyParams, NFT, RequiredParam, TransferNFTParams, WalletAddress, Erc721OrErc1155, NFTContract } from "../../types";
import { Erc1155, QueryAllParams } from "@thirdweb-dev/sdk";
import { BigNumber, BigNumberish } from "ethers";
/**
 * @internal
 */
export declare function convertResponseToNFTType(contract: Erc721OrErc1155, metadata: Awaited<ReturnType<typeof contract["get"]>>): NFT<typeof contract>;
/**
 * @internal
 */
export declare function convertResponseToNFTTypeArray(contract: Erc721OrErc1155, metadata: Awaited<ReturnType<typeof contract["get"]>>[]): NFT<typeof contract>[];
/** **********************/
/**     READ  HOOKS     **/
/** **********************/
/**
 ...
 */
export declare function useNFT<TContract extends NFTContract>(contract: RequiredParam<TContract>, tokenId: RequiredParam<BigNumberish>): import("@tanstack/react-query").UseQueryResult<NFT<Erc721OrErc1155>, unknown>;
/**
 ...
 * @beta
 */
export declare function useNFTs<TContract extends NFTContract>(contract: RequiredParam<TContract>, queryParams?: QueryAllParams): import("@tanstack/react-query").UseQueryResult<NFT<Erc721OrErc1155>[], unknown>;
/**
 ...
 * @twfeature ERC721Supply | ERC1155Enumerable
 */
export declare function useTotalCirculatingSupply(contract: RequiredParam<NFTContract>, tokenId: BigNumberish): import("@tanstack/react-query").UseQueryResult<BigNumber, unknown>;
/**
 ...
 */
export declare function useOwnedNFTs<TContract extends NFTContract>(contract: RequiredParam<TContract>, ownerWalletAddress: RequiredParam<WalletAddress>): import("@tanstack/react-query").UseQueryResult<NFT<Erc721OrErc1155>[], unknown>;
/**
