import { DropContract, RequiredParam, WalletAddress } from "../../types";
 ...
 * @beta
 */
export declare function useClaimIneligibilityReasons(contract: RequiredParam<DropContract>, params: ClaimIneligibilityParams, tokenId?: BigNumberish): import("@tanstack/react-query").UseQueryResult<import("@thirdweb-dev/sdk").ClaimEligibility[] | undefined, unknown>;
/** **********************/
/**     WRITE HOOKS     **/
/** **********************/
/**
