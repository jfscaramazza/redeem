import { ClaimNFTParams, ClaimNFTReturnType, DelayedRevealLazyMintInput, DropContract, RequiredParam, RevealLazyMintInput, NFTContract, RevealableContract } from "../../types";
 ...
 * @beta
 */
export declare function useClaimedNFTs(contract: RequiredParam<NFTContract>, queryParams?: QueryAllParams): import("@tanstack/react-query").UseQueryResult<import("../../types").NFT<import("../../types").Erc721OrErc1155>[], unknown>;
/**
 *
