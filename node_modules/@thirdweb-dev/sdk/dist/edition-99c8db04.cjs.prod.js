...
class Edition extends dist_thirdwebDevSdk.StandardErc1155 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, Edition.contractRoles);
...
dist_thirdwebDevSdk._defineProperty(Edition, "contractRoles", ["admin", "minter", "transfer"]);
