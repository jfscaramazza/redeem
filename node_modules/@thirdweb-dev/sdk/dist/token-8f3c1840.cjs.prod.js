...
class Token extends dist_thirdwebDevSdk.StandardErc20 {
  /**
   * Signature Minting
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, Token.contractRoles);
...
dist_thirdwebDevSdk._defineProperty(Token, "contractRoles", ["admin", "minter", "transfer"]);
