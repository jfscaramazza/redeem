...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([EditionDropInitializer.getAbi(), import('./edition-drop-cfefeceb.esm.js')]);
...
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([EditionInitializer.getAbi(), import('./edition-5b9bbd09.esm.js')]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([MarketplaceInitializer.getAbi(), import('./marketplace-47dfe900.esm.js')]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([MultiwrapInitializer.getAbi(), import('./multiwrap-8d959559.esm.js')]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([NFTCollectionInitializer.getAbi(), import('./nft-collection-58f2b4f8.esm.js')]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([NFTDropInitializer.getAbi(), import('./nft-drop-0b94766d.esm.js')]);
...
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([PackInitializer.getAbi(), import('./pack-f2040e4c.esm.js')]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([SignatureDropInitializer.getAbi(), import('./signature-drop-f6d1ffba.esm.js')]);
...
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([SplitInitializer.getAbi(), import('./split-811ec9e8.esm.js')]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([TokenDropInitializer.getAbi(), import('./token-drop-c0f95f5f.esm.js')]);
...
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([TokenInitializer.getAbi(), import('./token-6c5929e8.esm.js')]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract] = await Promise.all([VoteInitializer.getAbi(), import('./vote-8fe14fb7.esm.js')]);
...
class ContractDeployer extends RPCConnectionHandler {
  ...
  async deployContractFromUri(publishMetadataUri, constructorParamValues, options) {
    ...
    if (isDeployableViaFactory && factoryDeploymentData && !forceDirectDeploy) {
      ...
      invariant(factoryAddress, `factoryAddress not found for chainId '${chainId}'`);
