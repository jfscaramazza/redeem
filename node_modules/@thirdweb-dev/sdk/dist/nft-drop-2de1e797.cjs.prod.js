...
class NFTDrop extends dist_thirdwebDevSdk.StandardErc721 {
  /**
   * @internal
   */
  ...
  constructor(network, address, storage) {
    ...
    dist_thirdwebDevSdk._defineProperty(this, "checkout", void 0);
    ...
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, NFTDrop.contractRoles);
    ...
    this.checkout = new dist_thirdwebDevSdk.PaperCheckout(this.contractWrapper);
  }
  /**
   * @internal
   */
  ...
  async createBatch(metadatas, options) {
    ...
    const batch = await dist_thirdwebDevSdk.uploadOrExtractURIs(metadatas, this.storage, startFileNumber.toNumber(), options); // ensure baseUri is the same for the entire batch
...
dist_thirdwebDevSdk._defineProperty(NFTDrop, "contractRoles", ["admin", "minter", "transfer"]);
