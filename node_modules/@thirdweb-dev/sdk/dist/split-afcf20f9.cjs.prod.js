...
class Split {
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, Split.contractRoles);
...
dist_thirdwebDevSdk._defineProperty(Split, "contractRoles", ["admin"]);
