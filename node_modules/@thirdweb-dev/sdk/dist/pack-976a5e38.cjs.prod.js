...
class Pack extends dist_thirdwebDevSdk.StandardErc1155 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : new dist_thirdwebDevSdk.ContractWrapper(network, address, abi, options.gasless && "openzeppelin" in options.gasless ? { ...options,
      gasless: {
    ...
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, Pack.contractRoles);
...
dist_thirdwebDevSdk._defineProperty(Pack, "contractRoles", ["admin", "minter", "asset", "transfer"]);
