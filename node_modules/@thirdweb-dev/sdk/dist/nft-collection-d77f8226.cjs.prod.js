...
class NFTCollection extends dist_thirdwebDevSdk.StandardErc721 {
  /**
   * Configure royalties
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new dist_thirdwebDevSdk.ContractRoles(this.contractWrapper, NFTCollection.contractRoles);
...
dist_thirdwebDevSdk._defineProperty(NFTCollection, "contractRoles", ["admin", "minter", "transfer"]);
